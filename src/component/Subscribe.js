...
const Subscribe = () => {
  return (
    <div className="bg-secondary lg:h-[321px] h-80 bg-cover bg-no-repeat" >
      <div className='flex lg:flex-row flex-col justify-center items-center h-full lg:px-32 px-3'>

        <div className="mb-3 lg:mb-0">
          <h1 className="lg:text-5xl text-2xl text-center text-white font-bold capitalize lg:leading-[65px]">Subscribe our newsletter<br /> for newest books update</h1>
        </div>
