    ...
    <div className="bg-secondary lg:h-[321px] h-80 bg-cover bg-no-repeat" >
      <div className='flex lg:flex-row flex-col mx-auto max-w-[1196px] justify-center items-center h-full lg:px-0 px-3'>
        ...
        <div className="mb-3 lg:mb-0">
          <h1 className="lg:text-[36px] text-white text-2xl font-bold capitalize lg:leading-[52px]">Subscribe our newsletter<br /> for newest books update</h1>
        </div>
        <div class="relative mt-3 lg:mt-0 lg:w-2/5 w-11/12 mx-auto">
          ...
          <button class="btn btn-primary absolute top-[4.5px] right-1 mt-[1px] mr-[2px] rounded-3xl text-white">Subscribe</button>
        </div>
