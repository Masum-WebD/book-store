...
const AllTopProducts = () => {
    ...
    return (
        <div>
            <h2 className='uppercase text-primary text-lg mt-16 font-bold'>Top Selling books</h2>
            ...
            <div className='md:grid grid-cols-3 px-4 md:container mx-auto my-16 gap-5'>
                {
                    products.slice(9, 12).map(book => <AllProductSingle book={book}></AllProductSingle>)
                }
            </div>
        </div>
    );
