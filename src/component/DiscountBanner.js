            ...
            <div class="">
                <div class=" lg:py-0 lg:flex justify-between items-center lg:flex-row-reverse">
                    ...
                    <div className='lg:w-3/6 p-3 lg:p-0 text-left'>
                        <h1 class="lg:text-[36px] text-2xl font-bold text-neutral capitalize lg:leading-[52px]">Get 20% Discount on any kind of historical books</h1>
                        <Link to="/all-products" class="btn btn-primary capitalize text-white rounded-sm mt-8">Shop Now</Link>
                    </div>
                </div>
            </div>
        </section>
