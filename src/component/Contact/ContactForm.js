    ...
    return (
        <div className='md:block lg:flex justify-around container lg:p-20 p-4'>
            <div className=' md: w-full lg:w-1/2 text-start'>
                ...
                <p className='text-[16px] text-[#39454F] mt-6'>Send an Email. All Fields with an asterisk (*) are required.</p>
                <form onSubmit={formControl} className='mt-8'>
                    <div className='md:block lg:flex justify-between'>
                        <div>
                            <label htmlFor="" className='text-[16px] text-gray-400'>Name*</label>
                            <input type="text" class="input  input-accent w-full  text-black" required />
                        </div>
                        <div className='md:ml-0 lg:ml-5'>
                            <label htmlFor="" className='text-[16px] text-gray-400'>Email*</label>
                            <input type="email" class="input input-accent w-full  text-black" required />

                        </div>
                    </div>
                    <div className='mt-5'>
                        <label htmlFor="" className='text-[16px] text-gray-400'>Subject</label>
                        <input type="text" class="input input-accent w-full text-black" />
                    </div>
                    <div className='mt-5'>
                        <label htmlFor="" className='text-[16px] text-gray-400'>Message*</label>
                        <textarea class="textarea textarea-accent w-full lg:h-60 text-black" required></textarea>
                    </div>
                    <div className='text-center mt-5'>
                        <button className="btn bg-[#27AE61] border-none hover:bg-[#51bf81] w-1/2">Submit</button>
                    </div>
                </form>
            </div>
            <div className='md:ml-0 md:w-full lg:ml-20 lg:w-1/2  text-start'>
                ...
                <div className='md:block lg:flex justify-between mt-10'>
                    <div className='md:w-full lg:w-1/2'>
                        ...
                        <div className='text-start  mt-4 font-medium'>
                            <div className='flex items-center'>
                                ...
                                <p className='text-[16px] text-black ml-6'>Broklin, My Street</p>
                            </div>
                            <div className='flex  items-center'>
                                ...
                                <p className='text-[16px] text-black ml-6'>NY 10036</p>
                            </div>
                            <div className='flex  items-center'>
                            ...
                            <div className='flex  items-center'>
                                ...
                                <p className='text-[16px] text-black ml-6'>United States
                                </p>
                            </div>
                            <div className='flex items-center'>
                                ...
                                <p className='text-[16px] text-black ml-6 '>+04321 0123456
                                </p>
                            </div>
                            <div className='flex items-center'>
                                ...
                                <p className='text-[16px] text-black ml-6'>http://www.example.com</p>
                            </div>
                        </div>
                        <div>
                        </div>
                    ...
                    <div className='md:w-full lg:w-1/2'>
                        <h2 className='text-[16px] text-black font-medium uppercase'>Links</h2>
                        ...
                        <div className='mt-4 font-medium'>
                            ...
                            <div className='flex  items-center'>
                                ...
                                <p className='text-[16px] text-black ml-6'>Google Plus</p>
                            </div>
                            <div className='flex  items-center'>
