...
const TermDetails = () => {
    return (
        <div className='container w-11/12 mx-auto pt-20 font-serif text-start pb-20'>
            ...
            <div className='mt-5'>
                <h3 className='text-2xl text-black font-medium mt-4'>B. PRIVACY</h3>
                <p className='text-[16px] text-[#39454F] mt-2 leading-7'>
            ...
            <div className='mt-5'>
                <h3 className='text-2xl text-black font-medium mt-4'>C. PLATFORM FOR COMMUNICATION</h3>
                <p className='text-[16px] text-[#39454F] mt-2 leading-7'>
            ...
            <div className='mt-5'>
                <h3 className='text-2xl text-black font-medium mt-4'>D. CONTINUED AVAILABILITY OF THE SITE</h3>
                <p className='text-[16px] text-[#39454F] mt-2 leading-7'>
            ...
            <div className='mt-5'>
                <h3 className='text-2xl text-black font-medium mt-4'>E. LICENSE TO ACCESS THE SITE</h3>
                <p className='text-[16px] text-[#39454F] mt-2 leading-7'>
            ...
            <div className='mt-5'>
                <h3 className='text-2xl text-black font-medium mt-4'>F. YOUR CONDUCT</h3>
            ...
            <div className='mt-5'>
                <h3 className='text-2xl text-black font-medium mt-4'>G. YOUR SUBMISSION</h3>
                <p className='text-[16px] text-[#39454F] mt-2 leading-7'>
            ...
            <div className='mt-5'>
                <h2 className='text-2xl text-black font-semibold'>CONDITIONS OF SALE (BETWEEN SELLERS AND CUSTOMERS)</h2>
                <p className='text-[16px] text-[#39454F] mt-2 leading-7'>
