    ...
    return (
        <div className='container w-11/12 mx-auto pt-20 max-w-[1196px] text-start pb-20'>
            ...
            <div className='mt-5'>
                ...
                <p className='text-[16px] text-[#0B1B28] mt-2 leading-7'><strong>Delivery Timeline:</strong> The delivery might take longer than usual timeframe/line to be followed by Online Bookstore.</p>
