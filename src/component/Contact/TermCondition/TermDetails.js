...
const TermDetails = () => {
    return (
        <div className='container mx-auto pt-20 font-serif text-start pb-20'>
            <div>
                <h2 className='text-4xl text-black font-semibold'>Introduction</h2>
            ...
            <div className='mt-5'>
                <h3 className='text-3xl text-black font-medium mt-4'>B. PRIVACY</h3>
                <p className='text-xl text-gray-500 mt-2 leading-7'>
            ...
            <div className='mt-5'>
                <h3 className='text-3xl text-black font-medium mt-4'>C. PLATFORM FOR COMMUNICATION</h3>
                <p className='text-xl text-gray-500 mt-2 leading-7'>
            ...
            <div className='mt-5'>
                <h3 className='text-3xl text-black font-medium mt-4'>D. CONTINUED AVAILABILITY OF THE SITE</h3>
                <p className='text-xl text-gray-500 mt-2 leading-7'>
            ...
            <div className='mt-5'>
                <h3 className='text-3xl text-black font-medium mt-4'>E. LICENSE TO ACCESS THE SITE</h3>
                <p className='text-xl text-gray-500 mt-2 leading-7'>
            ...
            <div className='mt-5'>
                <h3 className='text-3xl text-black font-medium mt-4'>F. YOUR CONDUCT</h3>
            ...
            <div className='mt-5'>
                <h3 className='text-3xl text-black font-medium mt-4'>G. YOUR SUBMISSION</h3>
                <p className='text-xl text-gray-500 mt-2 leading-7'>
            ...
            <div className='mt-5'>
                <h2 className='text-4xl text-black font-semibold'>CONDITIONS OF SALE (BETWEEN SELLERS AND CUSTOMERS)</h2>
                <p className='text-xl text-gray-500 mt-2 leading-7'>
                ...
                <h3 className='text-3xl text-black font-medium mt-4'>A. CONDITIONS RELATED TO SALE OF THE PRODUCT OR SERVICE</h3>
                <p className='text-xl text-gray-500 mt-2 leading-7'>This section deals with conditions relating to the sale of products or services on the Site.</p>
            </div>

            <div className='mt-5'>
                <h3 className='text-3xl text-black font-medium mt-4'>B. THE CONTRACT</h3>
                <p className='text-xl text-gray-500 mt-2 leading-7'>
