...
const Features = () => {
    return (
        <section className='px-3 lg:px-0 max-w-[1196px] mx-auto mt-16 mb-24'>

            <div className='grid lg:grid-cols-5 grid-cols-3 gap-7'>

                <div className='border border-gray-[#D8DBDD] rounded-2xl p-3 lg:p-6'>
                    <div>
